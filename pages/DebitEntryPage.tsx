  ...
  return (
    <div className="max-w-lg mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h2 className="text-2xl font-bold" style={{ color: '#1E1B4B' }}>Add Debit for {selectedCompany}</h2>
      </div>
      <div className="rounded-3xl p-6 sm:p-8" style={{ background: 'white', border: '1px solid #E0E7FF', borderRadius: '1.5rem', boxShadow: '0 4px 16px rgba(99,102,241,0.08)' }}>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium" style={{ color: '#6366F1' }}>Company</label>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <button
              ...
              style={!hasSlip
                ? { border: '2px solid #E11D48', background: '#FFF1F2', boxShadow: '0 0 0 2px #FECDD3' }
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: '#1E1B4B' }}>Without Slip</span>
            </button>
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: '#1E1B4B' }}>With Slip</span>
            </button>
          </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {['UPI', 'IMPS', 'NEFT'].map((m) => (
                  <button
                    ...
                    style={subMethod === m
                      ? { background: '#E11D48', border: '2px solid #E11D48', color: 'white', boxShadow: '0 4px 14px rgba(225,29,72,0.25)' }
                      : { background: 'white', border: '2px solid #E0E7FF', color: '#9CA3AF' }}
                  >
                    {m}
                  </button>
                ))}
          ...
          <div className={`${hasSlip && !slip ? 'opacity-50 pointer-events-none' : ''}`}>
            <label className="block text-sm font-black uppercase tracking-widest mb-2" style={{ color: '#6366F1' }}>Select Account</label>
            <select
              value={selectedBank}
              onChange={(e) => setSelectedBank(e.target.value)}
              className="w-full p-3 rounded-xl font-black uppercase outline-none transition-all"
          ...
          <div>
            <button
              ...
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium disabled:opacity-50"
